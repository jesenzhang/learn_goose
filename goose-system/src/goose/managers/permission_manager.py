...
class UserApprovalCallback(ApprovalCallback):
    ...
    async def request_approval(
        ...
        print(f"\n[Permission] Tool approval required: {tool_name}")
        if reason:
    ...
    def _check_safety(self, tool_name: str, arguments: Dict[str, Any]) -> bool:
        ...
        from .inspection_manager import ToolInspectionManager, ToolRequest
        ...
        return result.allowed and result.action.value == "allow"
...
class PermissionManager:
    ...
    def __init__(self):
        ...
        self._once_permissions: Dict[str, str] = {}
        self._lock = asyncio.Lock()
    ...
    def mark_once_used(self, tool_name: str) -> None:
        """Mark a tool as used once."""
        self._once_permissions[tool_name] = "used"

    def clear_once_permissions(self) -> None:
        """Clear once-permission cache."""
        self._once_permissions.clear()
