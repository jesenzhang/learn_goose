...
# The Pho API server should be started separately.
#
# Quick start:
#   Terminal 1: .\..\scripts\start_api.ps1
#   Terminal 2: .\start_react_editor.ps1
#
# Usage:
#     .\start_react_editor.ps1 [-Port PORT] [-ApiUrl API_URL]
#
# Examples:
#     .\start_react_editor.ps1
#     .\start_react_editor.ps1 -Port 8300
#     .\start_react_editor.ps1 -Port 3000 -ApiUrl "http://localhost:9000"
...
# Set paths
$REACT_EDITOR_DIR = Join-Path $PSScriptRoot "react-editor"
