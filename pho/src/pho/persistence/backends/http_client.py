...
class HttpClient:
    ...
    async def _request(
        ...
        **kwargs
        ...
        # Add transaction_id to request data if in transaction
    ...
    async def update_by(self, table: str, filters: Dict, data: Dict) -> Dict:
    ...
    async def delete_by(self, table: str, filters: Dict) -> Dict:
