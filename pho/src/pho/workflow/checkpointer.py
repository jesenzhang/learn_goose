...
WORKFLOW_CHECKPOINT_SCHEMA = """
    CREATE TABLE IF NOT EXISTS workflow_checkpoints (
        ...
        session_id TEXT,        -- 多用户支持：关联的会话 ID
...
@with_table(name='workflow_checkpoints',model=WorkflowCheckpointEntity,sql=[WORKFLOW_CHECKPOINT_SCHEMA,WORKFLOW_CHECKPOINT_INDEX],priority=0,pk='run_id',attr_name='checkpoint_spec')
