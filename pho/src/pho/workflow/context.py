...
if TYPE_CHECKING:
    from pho.sandbox import ICodeSandbox
    from pho.resources import ResourceManager
    from pho.workflow.scheduler import WorkflowScheduler # 或者定义一个 Executor Protocol
    from pho.events import IStreamer
...
class WorkflowContext(BaseModel):
    ...
    def sandbox(self) -> 'CodeSandbox':
        ...
        if self._sandbox is None:
            from pho.sandbox import NativeSandboxAdapter
