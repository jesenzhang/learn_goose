"""
Base tool class and types for pho tools module.

This module defines core Tool interface and related types
...
class Tool(ABC):
    ...
    Each tool should:
    1. Define its input parameters as a Pydantic model or in __schema
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        Args:
            config: Optional configuration dictionary for tool.
        """
